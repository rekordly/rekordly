...
export const personalInfoSchema = z.object({
  ...
  phoneNumber: z.string()
    .regex(/^0(70|71|80|81|90|91)[0-9]{8}$/, { 
      message: 'Please enter a valid Nigerian phone number (11 digits starting with 070, 071, 080, 081, 090, or 091)' 
    }),
...
export const workTypeSchema = z.object({
  workType: z.string()
    .min(1, { message: 'Please select your work type' })
    .refine((val) => ['self-employed', 'freelancer', 'remote-worker', 'business-owner', 'digital-trader'].includes(val), {
