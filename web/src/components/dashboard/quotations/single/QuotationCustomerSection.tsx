...
export default function QuotationCustomerSection({
  quotation,
}: QuotationCustomerSectionProps) {
  const customerName =
    quotation.customer?.name || quotation.customerName || 'N/A';
  const customerEmail = quotation.customer?.email || quotation.customerEmail;
