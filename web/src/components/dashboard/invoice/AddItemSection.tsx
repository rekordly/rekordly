...
import { AddItemFormType, InvoiceItemType } from '@/types/invoice';
import { addItemSchema } from '@/lib/validations/invoice';
...
export function AddItemSection() {
  ...
  const onAddItem = (data: AddItemFormType) => {
    // Use simple numeric ID instead of string
    ...
    // Update the items in the main form
