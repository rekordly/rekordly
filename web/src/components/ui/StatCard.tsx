...
export default function StatCard({
  ...
  const getGradientClasses = () => {
    ...
    const gradientMap = {
      primary: "bg-gradient-to-b dark:from-primary-800/40 from-primary-100/25 dark:to-[#131219] to-white from-0% via-50% to-90%",
      secondary: "bg-gradient-to-b dark:from-secondary-800/40 from-secondary-100/25 dark:to-[#131219] to-white from-0% via-50% to-90%",
    };
