    ...
    <div className="w-full h-screen bg-gradient-to-br from-brand-900 via-brand-800 to-brand-900 p-8 flex flex-col relative overflow-hidden">
      ...
      <div className="mb-8 z-10">
        ...
        <p className="text-brand-200 text-sm leading-relaxed">
          Sign up is simple, free and fast. One place to manage<br />
        ...
        <Card className="bg-white/95 backdrop-blur-sm">
          <CardBody className="p-4">
            ...
            {teamMembers.map((member, idx) => (
              <div key={idx} className="flex items-center justify-between py-2 px-2 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                <span className="text-sm text-gray-600 flex-1 text-center">{member.role}</span>
          ...
          <CardBody className="p-5">
            <div className="mb-4">
              <div className="text-sm text-gray-700 mb-1">
                Cost to hire a <span className="text-red-600 font-semibold">Engineer</span> in
              </div>
              <div className="flex items-center gap-2">
                <span className="text-2xl">🇦🇺</span>
                <span className="text-brand-600 font-semibold">Australia</span>
              </div>
              <Chip size="sm" variant="flat" className="mt-2">ANNUALLY</Chip>
            </div>
            <div className="space-y-3 border-t pt-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Mandatory employer costs</span>
